...
public class ChangeSecurityQuestion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 6, 291, -1));
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(95, 98, -1, -1));

        txtoldsecurityquestion.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        getContentPane().add(txtoldsecurityquestion, new org.netbeans.lib.awtextra.AbsoluteConstraints(313, 95, 298, -1));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("New Security Question");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(95, 151, -1, -1));

        txtnewsecurityquestion.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        txtnewsecurityquestion.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtnewsecurityquestionKeyReleased(evt);
            }
        });
        getContentPane().add(txtnewsecurityquestion, new org.netbeans.lib.awtextra.AbsoluteConstraints(313, 148, 298, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("New Answer");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(95, 197, 105, -1));

        txtnewanswer.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        txtnewanswer.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtnewanswerKeyReleased(evt);
            }
        });
        getContentPane().add(txtnewanswer, new org.netbeans.lib.awtextra.AbsoluteConstraints(313, 200, 298, -1));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Password");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(95, 256, 93, -1));
        ...
        getContentPane().add(txtpassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(313, 253, 298, -1));
        ...
        getContentPane().add(btnupdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(313, 297, -1, -1));
        ...
        getContentPane().add(btnclear, new org.netbeans.lib.awtextra.AbsoluteConstraints(515, 297, -1, -1));
